...
import { AddClerkIdToUserFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789600000000-add-clerk-id-to-user';
...
export const INSTANCE_COMMANDS = [
  ...
  AddClerkIdToUserFastInstanceCommand,
];
